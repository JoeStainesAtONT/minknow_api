...
class InstanceServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.get_host_type = channel.unary_unary(
        '/minknow_api.instance.InstanceService/get_host_type',
        request_serializer=minknow__api_dot_instance__pb2.GetHostTypeRequest.SerializeToString,
        response_deserializer=minknow__api_dot_instance__pb2.GetHostTypeResponse.FromString,
        )
...
def add_InstanceServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'get_host_type': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=minknow__api_dot_instance__pb2.GetHostTypeRequest.FromString,
          response_serializer=minknow__api_dot_instance__pb2.GetHostTypeResponse.SerializeToString,
      ),
